            ...
            if (data[i].pid == 0) {
                ...
                if (option.type == 0) {
                    listHtml = $('<div class="f-treeList f-treeListOne">' +
							...
							'<div class="f-treeList-titleP"><div class="f-top">作业名称</div>' +
                            '<div class="f-center"><span class="f-startdate">计划开始：2019-03-21</span><span class="f-finishdate">计划结束：2019-03-21</span><span class="f-duration">工期：2019</span></div>' +
                            '<div class="f-bottom"><span>进度：</span><div class="f-progress"><span class="f-progressValue"></span></div>' +
                             '<span class="f-progressText">50%</span>' +
                            '<span class="f-progressStatus">延期完成</span>' +
                            '</div></div>' +
                            '<a class="f-link" href="to.html"></a>' +
							'</div></div></div>');
                };
                ///有选择框
                if (option.type == 1) {
