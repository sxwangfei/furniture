...
configFun.prototype = {
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i].pid == 0) {
                ...
                if (option.type == 0) {
                    ...
                    listHtml = $('<div class="f-treeList f-treeListOne" style="background-color:' + t.getLevelColor(option, levelRef[data[i].id]) + ';">' +
							...
							'<div class="f-treeList-titleP"><div class="f-top">' + data[i].title + '</div>' +
                            '<div class="f-center"><span class="f-startdate">计划开始：' + data[i].start + '</span><span class="f-finishdate">计划结束：' + data[i].finish + '</span><span class="f-duration">工期：' + data[i].duration + '</span></div>' +
                            '<div class="f-bottom"><span>进度：</span><div class="f-progress"><span class="f-progressValue" style="width:' + parseInt(data[i].progress * 0.5) + 'px;"></span></div>' +
                            '<span class="f-progressText">' + data[i].progress + '%</span>' +
                            '<span class="f-progressStatus">延期完成</span>' +
                            '</div></div>' +
                            '<a class="f-link" ></a>' +
							'</div></div></div>');
                };
    ...
    getLevelColor: function (option, level) {
        var t = this;
